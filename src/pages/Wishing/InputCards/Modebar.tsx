...
import { Box, CardActionArea, Dialog, DialogContent, DialogTitle, Divider, Grid, IconButton, Link, styled } from '@mui/material';
    ...
    <Card sx={{ backgroundImage: 'none', backgroundColor: "#307ac3aa", color: '#fff' }}>
      ...
      {approach == 'calculation' &&
        <Dialog open={open} onClose={handleClose} >
          <DialogTitle sx={{ bgcolor: '#242734', display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: { xs: 22, sm: 26 }, textDecoration: 'underline' }}>
            How it works
            <CloseButton onClick={handleClose} sx={{ width: '30px', height: '30px', borderRadius: 1, marginLeft: 'auto' }}>
              <Close />
            </CloseButton>
          </DialogTitle>
          <DialogContent sx={{ bgcolor: '#242734', fontSize: { xs: 16, sm: 20 } }}>
      ...
      {approach == 'simulation' &&
        <Dialog open={open} onClose={handleClose} >
          ...
          <DialogContent sx={{ bgcolor: '#242734', pl: 5, fontSize: { xs: 16, sm: 20 } }}>
