...
export default function Chart({ plotdata }: { plotdata: Plotdata }) {
  const [trace, setTrace] = useState(() => ({ x: plotdata.x, y: plotdata.y, name: "", mode: 'line', line: { color: '#1772CB', size: 2 }, hovertemplate: "<b> %{y:.2f}% <br> %{x:.0f} Days <br>" }));
