...
export default function Pity() {
    ...
    <div style={{display: 'flex', height: '52px'}}>
        <label style={{display: 'flex'}}>
            ...
            <Input disableUnderline={true} value={count} onChange={updatecount} inputProps={{ step: 1, min: 0, max: 89, type: 'number', style: { textAlign: 'center', width: 40, padding: '3px 0px'} }} sx={{width: "60px", bgcolor: '#3A77D7', color: '#FFF', borderRadius: '0px 6px 6px 0px', margin: "8px 8px 8px 0px", px: '8px'}} />
        </label>
    </div>
  )
}
