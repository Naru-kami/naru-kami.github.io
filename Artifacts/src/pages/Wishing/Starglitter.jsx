...
export default function Starglitter() {
    ...
    <FormGroup>
    <FormControlLabel sx={{mr: 'auto'}} label={<Typography variant="h7" style={{ color: '#fff' }} >Use Starglitter? </Typography>} control={<Checkbox value={check} onChange={updatecheck}/>} labelPlacement="start"/>
    </FormGroup>
    </Card>
    { check &&
    <Card variant='outlined' sx={{bgcolor: 'inherit'}}>
